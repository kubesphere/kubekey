...
func IsPaused(cluster *kubekeyv1.Cluster, o metav1.Object) bool {
...
func HasPaused(o metav1.Object) bool {
	return hasAnnotation(o, kubekeyv1.PausedAnnotation)
}
...
func HasSkipRemediation(o metav1.Object) bool {
	return hasAnnotation(o, kubekeyv1.MachineSkipRemediationAnnotation)
}
