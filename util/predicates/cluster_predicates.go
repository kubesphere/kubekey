...
func ClusterCreateInfraReady(logger logr.Logger) predicate.Funcs {
	return predicate.Funcs{
		CreateFunc: func(e event.CreateEvent) bool {
			...
			c, ok := e.Object.(*kubekeyv1.Cluster)
			if !ok {
...
func ClusterUpdateInfraReady(logger logr.Logger) predicate.Funcs {
	return predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			...
			oldCluster, ok := e.ObjectOld.(*kubekeyv1.Cluster)
			if !ok {
			...
			newCluster := e.ObjectNew.(*kubekeyv1.Cluster)
...
func ClusterControlPlaneInitialized(logger logr.Logger) predicate.Funcs {
	return predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			...
			if !conditions.IsTrue(oldCluster, kubekeyv1.ControlPlaneInitializedCondition) &&
				conditions.IsTrue(newCluster, kubekeyv1.ControlPlaneInitializedCondition) {
...
func processIfTopologyManaged(logger logr.Logger, object client.Object) bool {
	cluster, ok := object.(*kubekeyv1.Cluster)
	if !ok {
