...
type PatchOperation struct {
	Before *kubekeyv1.Condition
	After  *kubekeyv1.Condition
...
type applyOptions struct {
	ownedConditions []kubekeyv1.ConditionType
	forceOverwrite  bool
}

func (o *applyOptions) isOwnedCondition(t kubekeyv1.ConditionType) bool {
...
func WithOwnedConditions(t ...kubekeyv1.ConditionType) ApplyOption {
