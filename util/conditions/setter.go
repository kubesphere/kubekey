...
type Setter interface {
	Getter
	SetConditions(kubekeyv1.Conditions)
}
...
func Set(to Setter, condition *kubekeyv1.Condition) {
...
func TrueCondition(t kubekeyv1.ConditionType) *kubekeyv1.Condition {
	return &kubekeyv1.Condition{
		Type:   t,
...
func FalseCondition(t kubekeyv1.ConditionType, reason string, severity kubekeyv1.ConditionSeverity, messageFormat string, messageArgs ...interface{}) *kubekeyv1.Condition {
	return &kubekeyv1.Condition{
		Type:     t,
...
func UnknownCondition(t kubekeyv1.ConditionType, reason string, messageFormat string, messageArgs ...interface{}) *kubekeyv1.Condition {
	return &kubekeyv1.Condition{
		Type:    t,
...
func MarkTrue(to Setter, t kubekeyv1.ConditionType) {
	Set(to, TrueCondition(t))
}

// MarkUnknown sets Status=Unknown for the condition with the given type.
func MarkUnknown(to Setter, t kubekeyv1.ConditionType, reason, messageFormat string, messageArgs ...interface{}) {
...
func MarkFalse(to Setter, t kubekeyv1.ConditionType, reason string, severity kubekeyv1.ConditionSeverity, messageFormat string, messageArgs ...interface{}) {
...
func SetMirror(to Setter, targetCondition kubekeyv1.ConditionType, from Getter, options ...MirrorOptions) {
...
func SetAggregate(to Setter, targetCondition kubekeyv1.ConditionType, from []Getter, options ...MergeOption) {
	Set(to, aggregate(from, targetCondition, options...))
}

// Delete deletes the condition with the given type.
func Delete(to Setter, t kubekeyv1.ConditionType) {
	if to == nil {
		return
	}

	conditions := to.GetConditions()
	newConditions := make(kubekeyv1.Conditions, 0, len(conditions))
...
func lexicographicLess(i, j *kubekeyv1.Condition) bool {
	return (i.Type == kubekeyv1.ReadyCondition || i.Type < j.Type) && j.Type != kubekeyv1.ReadyCondition
}
...
func hasSameState(i, j *kubekeyv1.Condition) bool {
