...
type mergeOptions struct {
	conditionTypes                     []kubekeyv1.ConditionType
	addSourceRef                       bool
	addStepCounter                     bool
	addStepCounterIfOnlyConditionTypes []kubekeyv1.ConditionType
	stepCounter                        int
}
...
func WithConditions(t ...kubekeyv1.ConditionType) MergeOption {
...
// IMPORTANT: This options works only while generating the Summary condition.
func WithStepCounterIfOnly(t ...kubekeyv1.ConditionType) MergeOption {
	return func(c *mergeOptions) {
...
func getFirstReason(g conditionGroups, order []kubekeyv1.ConditionType, addSourceRef bool) string {
...
func getFirstMessage(groups conditionGroups, order []kubekeyv1.ConditionType) string {
...
func getFirstCondition(g conditionGroups, priority []kubekeyv1.ConditionType) *localizedCondition {
	topGroup := g.TopGroup()
	if topGroup == nil {
		return nil
	}
