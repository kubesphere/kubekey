...
func merge(conditions []localizedCondition, targetCondition kubekeyv1.ConditionType, options *mergeOptions) *kubekeyv1.Condition {
...
func (g conditionGroups) TrueGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionTrue, kubekeyv1.ConditionSeverityNone)
}
...
func (g conditionGroups) ErrorGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, kubekeyv1.ConditionSeverityError)
}
...
func (g conditionGroups) WarningGroup() *conditionGroup {
	return g.getByStatusAndSeverity(corev1.ConditionFalse, kubekeyv1.ConditionSeverityWarning)
}

func (g conditionGroups) getByStatusAndSeverity(status corev1.ConditionStatus, severity kubekeyv1.ConditionSeverity) *conditionGroup {
	if len(g) == 0 {
		return nil
	}
	for _, group := range g {
...
type conditionGroup struct {
	...
	severity   kubekeyv1.ConditionSeverity
...
func (g conditionGroup) mergePriority() int {
	...
	case corev1.ConditionFalse:
		switch g.severity {
		case kubekeyv1.ConditionSeverityError:
			return 0
		case kubekeyv1.ConditionSeverityWarning:
			return 1
		case kubekeyv1.ConditionSeverityInfo:
			return 2
		}
