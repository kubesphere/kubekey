...
var kubectlKoTempl = template.Must(template.New("kubectlKo").Parse(
...
func GenerateKubectlKo(mgr *manager.Manager) (string, error) {
	return util.Render(kubectlKoTempl, util.Data{})
}
