...
func GetImage(runtime connector.ModuleRuntime, kubeConf *common.KubeConf, name string) Image {
	...
	ImageList := map[string]Image{
		...
		"multus":                  {RepoAddr: kubeConf.Cluster.Registry.PrivateRegistry, Namespace: "k8snetworkplumbingwg", Repo: "multus-cni", Tag: kubekeyv1alpha2.DefalutMultusVersion, Group: kubekeyv1alpha2.K8s, Enable: strings.Contains(kubeConf.Cluster.Network.Plugin, "multus")},
		// storage
