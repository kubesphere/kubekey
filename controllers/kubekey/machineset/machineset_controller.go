...
func patchMachineSet(ctx context.Context, patchHelper *patch.Helper, machineSet *kubekeyv1.MachineSet, options ...patch.Option) error {
	// Always update the readyCondition by summarizing the state of other conditions.
	conditions.SetSummary(machineSet,
		conditions.WithConditions(
			kubekeyv1.MachinesCreatedCondition,
			kubekeyv1.ResizedCondition,
			kubekeyv1.MachinesReadyCondition,
		),
	)
