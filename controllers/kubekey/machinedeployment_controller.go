...
//+kubebuilder:rbac:groups=kubekey.kubesphere.io,resources=machinedeployments,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kubekey.kubesphere.io,resources=machinedeployments/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kubekey.kubesphere.io,resources=machinedeployments/finalizers,verbs=update
...
func (r *MachineDeploymentReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kubekeyv1alpha3.MachineDeployment{}).
		Complete(r)
}
