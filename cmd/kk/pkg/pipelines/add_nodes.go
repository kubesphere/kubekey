...
func NewAddNodesPipeline(runtime *common.KubeRuntime) error {
	...
	m := []module.Module{
		...
		&etcd.CertsModule{Skip: runtime.Cluster.Kubernetes.ClusterAutoscale != nil && *runtime.Cluster.Kubernetes.ClusterAutoscale},
		...
		&etcd.BackupModule{Skip: runtime.Cluster.Etcd.Type != kubekeyapiv1alpha2.KubeKey || (runtime.Cluster.Kubernetes.ClusterAutoscale != nil && *runtime.Cluster.Kubernetes.ClusterAutoscale)},
