...
const (
	...
	PipelineCompletedFinalizer = "kkmachine.infrastructure.cluster.x-k8s.io/pipeline-completed"
...
type KKMachineSpec struct {
	...
	// A KKMachine created by KubeadmControlPlane will automatically have the "control-plane" role.
